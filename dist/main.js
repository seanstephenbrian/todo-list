...
console.log((0,_list_js__WEBPACK_IMPORTED_MODULE_1__.getAll)());

const body = document.querySelector('body');
body.addEventListener('click', () => {
    (0,_list_js__WEBPACK_IMPORTED_MODULE_1__.editTodo)('todo 4 title','title','a new title');
    console.log((0,_list_js__WEBPACK_IMPORTED_MODULE_1__.getAll)());
});
...
const renderNow = () => {
    return (0,_list_js__WEBPACK_IMPORTED_MODULE_0__.getNow)();
}

const renderLater = () => {
    return (0,_list_js__WEBPACK_IMPORTED_MODULE_0__.getLater)();
}

const renderAll = () => {
    return (0,_list_js__WEBPACK_IMPORTED_MODULE_0__.getAll)();
}
